...
typedef struct {
	uint8		keyByte[MF_KEY_SIZE];//keyByte[MF_KEY_SIZE] is an array with six bytes; keys A and B are each 6 bytes long (see defintion of MF_KEY_SIZE above)
} MIFARE_Key;
/* Exported define ------------------------------------------------------------*/
/* Exported macro -------------------------------------------------------------*/
/* Exported variables ---------------------------------------------------------*/
...
static const uint8 FIFO_SIZE = 64;		// The FIFO is 64 bytes.
/* Exported function prototypes ----------------------------------------------*/

/////////////////////////////////////////////////////////////////////////////////////
// Basic interface functions for communicating with the MFRC522
/////////////////////////////////////////////////////////////////////////////////////
void PCD_WriteRegister(uint8 reg, uint8 value);//Writes a uint8 to the specified register in the MFRC522 chip.
void PCD_WriteRegisterMulti(uint8 reg, uint8 count, uint8 *values);
uint8 PCD_ReadRegister(uint8 reg);
void PCD_ReadRegisterMulti(uint8 reg, uint8 count, uint8 *values, uint8 rxAlign);
void setBitMask(unsigned char reg, unsigned char mask);
void PCD_SetRegisterBitMask(uint8 reg, uint8 mask);
void PCD_ClearRegisterBitMask(uint8 reg, uint8 mask);
...
/////////////////////////////////////////////////////////////////////////////////////
uint8 PCD_TransceiveData(uint8 *sendData, uint8 sendLen, uint8 *backData, uint8 *backLen, uint8 *validBits, uint8 rxAlign, boolean checkCRC);
uint8 PCD_CommunicateWithPICC(uint8 command, uint8 waitIRq, uint8 *sendData, uint8 sendLen, uint8 *backData, uint8 *backLen, uint8 *validBits, uint8 rxAlign, boolean checkCRC);

uint8 PICC_RequestA(uint8 *bufferATQA, uint8 *bufferSize);
uint8 PICC_WakeupA(uint8 *bufferATQA, uint8 *bufferSize);
uint8 PICC_REQA_or_WUPA(	uint8 command, uint8 *bufferATQA, uint8 *bufferSize);
uint8 PICC_Select(Uid *uid, uint8 validBits);
uint8 PICC_HaltA(void);

/////////////////////////////////////////////////////////////////////////////////////
// Functions for communicating with MIFARE PICCs
/////////////////////////////////////////////////////////////////////////////////////
uint8 PCD_Authenticate(uint8 command, uint8 blockAddr, MIFARE_Key *key, Uid *uid);//this method is used to authenticate a certain block for writing or reading
...
uint8 MIFARE_Read(uint8 blockAddr, uint8 *buffer, uint8 bufferSize);//MIFARE_Read(block number (0-15), uint8 array containing 16 values, number of bytes in block (=16))
uint8 MIFARE_Write(uint8 blockAddr, uint8 *buffer, uint8 bufferSize);//MIFARE_Write(block number (0-15), uint8 array containing 16 values, number of bytes in block (=16))
uint8 MIFARE_Decrement(uint8 blockAddr, long delta);
uint8 MIFARE_Increment(uint8 blockAddr, long delta);
uint8 MIFARE_Restore(uint8 blockAddr);
uint8 MIFARE_Transfer(uint8 blockAddr);
uint8 MIFARE_Ultralight_Write(uint8 page, uint8 *buffer, uint8 bufferSize);

/////////////////////////////////////////////////////////////////////////////////////
// Support functions
/////////////////////////////////////////////////////////////////////////////////////
uint8 PCD_MIFARE_Transceive(	uint8 *sendData, uint8 sendLen, boolean acceptTimeout);
uint8 PCD_DumbVersion(void);
const char *GetStatusCodeName(uint8 code);
uint8 PICC_GetType(uint8 sak);
const char *PICC_GetTypeName(uint8 type);
void PICC_DumpToSerial(Uid *uid);
void PICC_DumpMifareClassicToSerial(Uid *uid, uint8 piccType, MIFARE_Key *key);
